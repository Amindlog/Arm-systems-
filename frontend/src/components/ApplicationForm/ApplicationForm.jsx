  ...
  if (loadingTeams) {
    return (
      <div className="application-form-overlay">
        <div className="application-form">Загрузка...</div>
      </div>
    );
  }
    ...
    <div className="application-form-overlay" onClick={onClose}>
      <div className="application-form" onClick={(e) => e.stopPropagation()}>
        <div className="application-form__header">
          <h2 className="application-form__title">Создать заявку</h2>
          <button
        ...
        <form onSubmit={handleSubmit} className="application-form__form">
          ...
          <div className="application-form__actions">
            <button
              type="button"
              onClick={onClose}
              className="application-form__button application-form__button--cancel"
            >
              Отмена
            </button>
            <button
